...
// console.log('pake fungsi yang palindromeSwapper');
console.log(palindromeSwapper('arcecar')); // TRUE
console.log(palindromeSwapper('racecar')); // TRUE
console.log(palindromeSwapper('recacar')); // FALSE
// console.log('-------------------------------------');
// // console.log('pake fungsi yang isPalindrome')
// console.log(isPalindrome('arcecar')); // TRUE
// console.log(isPalindrome('racecar')); // TRUE
// console.log(isPalindrome('recacar')); // FALSE
